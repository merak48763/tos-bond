...
const E = id => [null, "水", "火", "木", "光", "暗"][id] ?? "??";
const R = id => [null, "人族", "獸族", "妖族", "龍族", "神族", null, null, "魔族", null, "機械族"][id] ?? "??族";

const parseAbility = (id, [arg0, arg1]) => {
  switch(id) {
    case 20001:
      return `發動自身角色符石\n⇒ 將移動符石時觸碰的\n    首 ${arg0} 粒符石轉化為${E(arg1)}符石`;
    case 20002:
      return `首批消除自身角色符石\n⇒ 個人以 ${arg0}% 攻擊力追打 ${arg1} 次`;
    case 20003:
      return `首批消除自身角色符石\n⇒ 增加 ${arg0} 連擊 (Combo)`;
    case 20004:
      return `消除符石後，\n若場上有自身角色符石\n⇒ 將角色符石所在兩側的符石\n    轉化為${E(arg0)}${R(arg1)}符石`;
    case 20005:
      return `發動自身角色符石及\n首批沒有消除自身角色符石\n⇒ 自身技能 CD -${arg0}`;
    case 20006:
      return `發動自身角色符石及\n首批沒有消除自身角色符石\n⇒ 自身技能 EP +${arg0}`;
    ...
    case 20008:
      return `首批消除自身角色符石\n⇒ 自身無視敵人防禦力`;
    case 20009:
      return `首批消除自身角色符石\n⇒ 自身對${E(arg0)}屬性目標攻擊力 +${arg1}1%`;
    case 20010:
      return `首批消除自身角色符石\n⇒ 自身對${R(arg0)}目標攻擊力 +${arg1}%`;
    case 20011:
      return `首批消除自身角色符石\n⇒ 自身無視「攻前盾」`;
    case 20012:
      return `首批消除自身角色符石\n⇒ 自身無視「固定連擊盾」`;
